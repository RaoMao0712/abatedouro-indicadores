ALTER TABLE almoxarifado_lotes ADD COLUMN validade TEXT;
ALTER TABLE almoxarifado_lotes ADD COLUMN criado_por TEXT;
ALTER TABLE almoxarifado_lotes ADD COLUMN versao INTEGER NOT NULL DEFAULT 0;
ALTER TABLE almoxarifado_lotes ADD COLUMN atualizado_em TEXT;
...
CREATE TABLE IF NOT EXISTS almoxarifado_correcoes_entrada (
    id INTEGER PRIMARY KEY AUTOINCREMENT, entrada_id INTEGER NOT NULL, insumo_id INTEGER NOT NULL,
