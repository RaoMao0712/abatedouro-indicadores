...
CREATE TABLE IF NOT EXISTS linha_abate_velocidades_ideais (
    id INTEGER PRIMARY KEY AUTOINCREMENT, linha TEXT NOT NULL DEFAULT 'LINHA_ABATE',
...
CREATE TABLE IF NOT EXISTS linha_performance_snapshots_op (
    ...
    velocidade_id INTEGER NOT NULL, linha TEXT NOT NULL, configuracao TEXT NOT NULL,
    sku TEXT, velocidade_aves_hora TEXT NOT NULL, vigencia_inicio TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS linha_performance_reprocessos (
    id INTEGER PRIMARY KEY AUTOINCREMENT, op_id INTEGER NOT NULL,
    quantidade_aves TEXT NOT NULL, atravessou_linha INTEGER NOT NULL,
    data_hora TEXT NOT NULL, motivo TEXT NOT NULL, usuario TEXT NOT NULL,
    usuario_id INTEGER, execucao_original TEXT NOT NULL, chave_idempotencia TEXT,
    ativo_logico INTEGER NOT NULL DEFAULT 1, CHECK (atravessou_linha IN (0,1))
);
CREATE TABLE IF NOT EXISTS linha_performance_auditoria (
    id INTEGER PRIMARY KEY AUTOINCREMENT, op_id INTEGER, entidade TEXT NOT NULL,
