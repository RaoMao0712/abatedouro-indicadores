...
CREATE TABLE IF NOT EXISTS sku_versoes (
 id SERIAL PRIMARY KEY, sku_id INTEGER NOT NULL REFERENCES skus(id), versao INTEGER NOT NULL,
 ...
 usuario_nome TEXT NOT NULL, criado_em TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
 atualizado_em TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, UNIQUE(sku_id,versao));
...
CREATE TABLE IF NOT EXISTS etapas_catalogo (
 id SERIAL PRIMARY KEY, codigo TEXT NOT NULL UNIQUE, nome TEXT NOT NULL, natureza TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS roteiro_versoes (
 id SERIAL PRIMARY KEY, sku_versao_id INTEGER NOT NULL REFERENCES sku_versoes(id), versao INTEGER NOT NULL,
 status TEXT NOT NULL, vigencia_inicio TEXT NOT NULL, vigencia_fim TEXT, aprovado_por TEXT, aprovado_em TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS roteiro_etapas (
 id SERIAL PRIMARY KEY, roteiro_versao_id INTEGER NOT NULL REFERENCES roteiro_versoes(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS roteiro_etapa_insumos (
 id SERIAL PRIMARY KEY, roteiro_etapa_id INTEGER NOT NULL REFERENCES roteiro_etapas(id) ON DELETE CASCADE,
 insumo_id INTEGER NOT NULL REFERENCES almoxarifado_insumos(id), unidade TEXT NOT NULL,
 quantidade_fator NUMERIC NOT NULL, tipo_calculo TEXT NOT NULL, tolerancia_perda NUMERIC,
...
CREATE TABLE IF NOT EXISTS op_config_snapshots (
 id SERIAL PRIMARY KEY, op_id INTEGER NOT NULL UNIQUE REFERENCES ordens_producao(id), sku_id INTEGER REFERENCES skus(id),
