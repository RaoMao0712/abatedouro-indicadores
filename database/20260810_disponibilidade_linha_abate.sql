...
CREATE TABLE IF NOT EXISTS linha_abate_programacoes (
    id SERIAL PRIMARY KEY, op_id INTEGER UNIQUE NOT NULL,
...
CREATE TABLE IF NOT EXISTS linha_abate_paradas_planejadas (
    id SERIAL PRIMARY KEY, programacao_id INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS linha_abate_auditoria (
    id SERIAL PRIMARY KEY, op_id INTEGER NOT NULL, entidade TEXT NOT NULL,
...
ALTER TABLE apontamentos_paradas ADD COLUMN IF NOT EXISTS afeta_linha_abate INTEGER;
ALTER TABLE apontamentos_paradas ADD COLUMN IF NOT EXISTS natureza_disponibilidade TEXT;
ALTER TABLE apontamentos_paradas ADD COLUMN IF NOT EXISTS classificacao_alterada_em TEXT;
ALTER TABLE apontamentos_paradas ADD COLUMN IF NOT EXISTS classificacao_alterada_por TEXT;
ALTER TABLE apontamentos_paradas ADD COLUMN IF NOT EXISTS classificacao_justificativa TEXT;
