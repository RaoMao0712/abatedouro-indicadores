...
PLANO_CONTAS_MESTRE = [
    ...
    conta_mestre(4005, "Despesas Operacionais", "Manutencao Predial", linha_dre=LINHA_DESPESAS_OPERACIONAIS, tipo_conta="Saida", ordem_exibicao=140),
    conta_mestre(4006, "Despesas Operacionais", "Manutencao de Equipamentos", linha_dre=LINHA_DESPESAS_OPERACIONAIS, tipo_conta="Saida", ordem_exibicao=150, aliases=["Manutencao"]),
    ...
    conta_mestre(4101, "Despesas Operacionais", "Mao de Obra", "CLT", linha_dre=LINHA_DESPESAS_OPERACIONAIS, tipo_conta="Saida", aceita_subcategoria=True, ordem_exibicao=170, aliases=["Mao de Obra"]),
    conta_mestre(4102, "Despesas Operacionais", "Mao de Obra", "Encargos", linha_dre=LINHA_DESPESAS_OPERACIONAIS, tipo_conta="Saida", aceita_subcategoria=True, ordem_exibicao=180),
    ...
    conta_mestre(4104, "Despesas Operacionais", "Mao de Obra", "Ferias", linha_dre=LINHA_DESPESAS_OPERACIONAIS, tipo_conta="Saida", aceita_subcategoria=True, ordem_exibicao=200),
    conta_mestre(4105, "Despesas Operacionais", "Mao de Obra", "Rescisoes", linha_dre=LINHA_DESPESAS_OPERACIONAIS, tipo_conta="Saida", aceita_subcategoria=True, ordem_exibicao=210),
    conta_mestre(4106, "Despesas Operacionais", "Mao de Obra", "Terceiros", linha_dre=LINHA_DESPESAS_OPERACIONAIS, tipo_conta="Saida", aceita_subcategoria=True, ordem_exibicao=220),
    conta_mestre(4201, "Despesas Operacionais", "Servicos", "Transporte", linha_dre=LINHA_DESPESAS_OPERACIONAIS, tipo_conta="Saida", aceita_subcategoria=True, ordem_exibicao=230, aliases=["Servicos", "Servicos terceiros", "Fornecedor"]),
    ...
    conta_mestre(4302, "Despesas Operacionais", "Limpeza", linha_dre=LINHA_DESPESAS_OPERACIONAIS, tipo_conta="Saida", ordem_exibicao=300, aliases=["Material de Limpeza"]),
    conta_mestre(4303, "Despesas Operacionais", "EPIs", linha_dre=LINHA_DESPESAS_OPERACIONAIS, tipo_conta="Saida", ordem_exibicao=310),
    conta_mestre(4304, "Despesas Operacionais", "Uniformes", linha_dre=LINHA_DESPESAS_OPERACIONAIS, tipo_conta="Saida", ordem_exibicao=320),
    ...
    conta_mestre(4312, "Despesas Operacionais", "Outras Despesas Operacionais", linha_dre=LINHA_DESPESAS_OPERACIONAIS, tipo_conta="Saida", ordem_exibicao=400, aliases=["Outras saidas", "Cursos e Treinamentos", "Consultoria e Responsabilidade Tecnica", "Contratos com Clientes"]),
    ...
    conta_mestre(5006, "Resultado Nao Operacional", "Equipamentos", linha_dre=LINHA_RESULTADO_NAO_OPERACIONAL, tipo_conta="Saida", ordem_exibicao=550, imobilizado=True),
    ...
    conta_mestre(5011, "Resultado Nao Operacional", "Marketing", linha_dre=LINHA_RESULTADO_NAO_OPERACIONAL, tipo_conta="Saida", ordem_exibicao=600),
    ...
    conta_mestre(5015, "Resultado Nao Operacional", "Impostos", linha_dre=LINHA_RESULTADO_NAO_OPERACIONAL, tipo_conta="Saida", ordem_exibicao=640, aliases=["Impostos e Taxas"]),
