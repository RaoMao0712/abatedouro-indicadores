...
def register_manutencao_routes(app):
    ...
    def visualizar_ordem_manutencao(ordem_id):
        ...
        return render_template(
            ...
            status_opcoes=manutencao_service.status_opcoes_edicao_manutencao(ordem["status"]),
            tipos=manutencao_service.TIPOS_MANUTENCAO,
            prioridades=manutencao_service.PRIORIDADES_MANUTENCAO,
            tipos_objeto=manutencao_service.TIPOS_OBJETO_MANUTENCAO,
            equipamentos=manutencao_service.buscar_equipamentos_manutencao(),
            veiculos=manutencao_service.buscar_veiculos_manutencao(),
            categorias_prediais=manutencao_service.CATEGORIAS_PREDIAIS,
            locais_prediais=manutencao_service.LOCAIS_PREDIAIS,
            usuarios_solicitantes=manutencao_service.listar_usuarios_solicitantes_manutencao(),
            origens_os=manutencao_service.ORIGENS_ORDEM_MANUTENCAO,
